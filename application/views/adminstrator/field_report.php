      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="card-body">
                    ...
                    <form class="form-horizontal" method="post"  action="<?php echo base_url('inserting/add_report_assessor'); ?>">
            <div class="row">
            <div class="col-md-4">
                                  ...
                                  <select name="AID" required class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                    ...
                                    <?php if($assessors): ?>
                                      <?php foreach($assessors as $assessor): ?>
                                        ...
                                        <?php
                                        $total = 3; $allocated = 0;
                                          if($report_allocated):  $available = 0;
                                            foreach($report_allocated as $allo):
            ...
            <div id="table_data" class="table-responsive mailbox-messages">
                <table  class="table table-hover table-striped">
                  ...
                  <tbody>
                    <?php if($report_assessors): ?>
                      <?php foreach($report_assessors as $assessor): ?>
                        <tr>
                          ...
                          <td class="mailbox-subject">
                            ...
                            <?php if($assessor[0]): $no = 0; ?>
                                  <?php foreach($assessor[0] as $school_info):$no++; ?>
                                    <?php $path = base_url('updates/remove_report_assess/'.$school_info['id']); ?>
