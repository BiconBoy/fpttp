                    ...
                    <form class="form-horizontal" onsubmit="return change_pwd()">
                        ...
                        <div class="input-group">
                         <span class="input-group-text"><i class="fa fa-key"></i></span>
                          <input class="form-control form-control-sm" name="new_pass" placeholder="Input New password" minlength="6" type="password" required  onkeyup="check_pass()">
                          <span class="input-group-text"><i id="question1" class="fa fa-question"></i></span>
                        </div><br>

                        <div class="input-group">
                          <span class="input-group-text"><i class="fa fa-key"></i></span>
                          <input class="form-control form-control-sm" name="re_pass" placeholder="Retry New password"  minlength="6" type="password" required onkeyup="check_pass()">
...
function check_pass(){
   ...
   function change_pwd(){
    ...
    path = "<?php echo base_url().'updates/renew_password'; ?>";
    old_pass = $("input[name='old_pass'").val();
    re_pass = $("input[name='re_pass'").val();
    new_pass = $("input[name='new_pass'").val();
