...
<head>
 ...
 <link rel="icon" href="<?php echo base_url(); ?>assets/admin/images/logosua.gif">
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/LTE/plugins/font-awesome/css/font-awesome.min.css">
    <!-- DataTables -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/LTE/plugins/datatables/dataTables.bootstrap4.css">
  <!-- Ionicons -->
...
<body onload="set_interval()" onmousemove="reset_interval()" onclick="reset_interval()" onkeypress="reset_interval()" onscroll="reset_interval()" class="hold-transition sidebar-mini">
