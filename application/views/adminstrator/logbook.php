              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-8 offset-2 table-responsive">
                     <form onsubmit="return update_logbook_marks()">
                ...
                <?php foreach($students as $student): $no++; ?>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <?php if($student['logbook_confirm'] == 'YES'){ $over = 1; ?>
                        <?php echo $student['logbook']; ?>%
                      <?php }else{ ?>
                      <input class="form-control <?php if($student['logbook'] <= 0){ echo "bg-secondary"; }else{echo "bg-success";} ?> text-center" style="width: 100px;" type="number" value="<?php echo $student['logbook']; ?>" name="marks_<?php echo $student['id']; ?>" >
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-body">
        <p>Are you sure that you need to submit logbook scores?</p>
      ...
      <div class="modal-footer text-left">
        ...
        <a href="<?php echo base_url('updates/confirm_logbook_marks/'.$REG); ?>">
...
<script>
  function update_logbook_marks(){
   var marks = $('form').serializeArray();
   path ="<?php echo base_url('inserting/update_logbook_marks') ?>";
   $.ajax({
  url: path,
  type: "POST",
  data:  {marks:marks},
